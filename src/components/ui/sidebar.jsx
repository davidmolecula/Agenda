  ...
  return (
    (<div
      ...
      <div
        ...
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-violet-500 text-white group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm">
          {children}
        </div>
      </div>
    </div>)
